...
<body>
<h1>State possibly enum if have time</h1>
<p>
		Select a legislator to see their top ten donors 
	</p>
		<div class="container">
			<table class="table" border=3>
				...
				<tbody>
					<c:forEach items="${ legislator }" var="o" varStatus="loop">
						<tr>
							<td><a href="getlegislatordetails?id=${ legislator[loop.index].attributes.cid }">${ legislator[loop.index].attributes.firstlast }</a>  </td>
